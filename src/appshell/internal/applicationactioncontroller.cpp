...
void ApplicationActionController::revertToFactorySettings()
{
    ...
    promise.onResolve(this, [this](const IInteractive::Result& res) {
        ...
        std::string title = muse::trc("appshell", "Would you like to restart Sincrest now?");
        std::string question = muse::trc("appshell", "Sincrest needs to be restarted for these changes to take effect.");
